        ...
        <div>
            ...
            <div className='container-fluid'>
                <div className='container'>
                    <div className='row OurPortfolio-1 py-5'>
                        <p data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">Our extensive portfolio includes promising work samples from the various domains we work in. We have showcased our best pieces of work that will exhibit our creativity, reliability and allow you to make a wise decision whilst choosing your IT Partner.</p>
                        <p data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">As a full-service digital agency, we offer specialized web design, graphic design, and photography services to clients Australia-wide.</p>
                        <p data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">To witness the quality of work, and the efforts we put into every project- have a look at our respective portfolios below.</p>
                    </div>
                    <div className='row'>
                        <div className='col-lg-6 OurPortfolio-1 mb-5'>
                            <h3 data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">Web Design Portfolio</h3>
                        ...
                        <div className='col-lg-6 OurPortfolio-1' data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">
                ...
                <div className='container'>
                    <div className='row py-5'>
                        ...
                        <div className='col-lg-6 OurPortfolio-1'>
                            <h3 data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">Graphic Portfolio</h3>
                            <p data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">Our extensive graphic portfolio is built on creativity and our vision to not only create designs and logos but an impact that speaks volumes. We’ve designed logos for brands from various industries and domains, and have always ensured that every design aligns with their branding. Our graphic designers have put together their best pieces for you to have a look at!</p>
                            <div className='py-2' data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">
                                <a href="/" className='btn btn-dark View-portfolio' role='button'>VIEW PORTFOLIO</a>
                            </div>
            ...
            <div className='container-fluid'>
                <div className='container'>
                    <div className='row py-5'>
                        <div className='col-lg-6 OurPortfolio-1'>
                           <h3 data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">Photography Portfolio</h3>
            ...
            <div className='container-fluid' style={{backgroundColor:"#E8E8E86B"}}>
                <div className='container'>
                    <div className='row py-5'>
                        ...
                        <div className='col-lg-6 OurPortfolio-1'>
                            <h3 data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">Case Studies</h3>
                            <p data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">We’re here to dive deep into what it takes to make every project a success. At Make My Website, we believe in stimulating the growth of businesses by means of our expertise and the efforts we put in at every step. We’ve analyzed some of our prestigious projects to have some insights for ourselves and our potential clients to develop an understanding of our approach, and the quality of work we deliver.</p>
                            <div className='py-2' data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror={true} data-aos-once="false">
                                <a href="/" className='btn btn-dark View-portfolio' role='button'>VIEW PORTFOLIO</a>
                            </div>
                        </div>
