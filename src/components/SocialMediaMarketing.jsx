        ...
        <div>
            ...
            <div className='container-fluid' style={{backgroundColor:'#f5f5f5'}}>
                <div className='container py-5'>
                    <div className='social-media-marketing-1'>
                        <h3 data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false" className='py-2'>Why SMM builds your presence like none other:</h3>
            ...
            <div className='container'>
                <div className='social-media-marketing-2 py-5'>
                    <p data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">Social Media is a platform to establish your social identity, share your brand values, and insights about your business to those who can relate to it, and become your customers. </p>
                    <p data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">Research shows that people scroll through a brand’s social media to get an idea about their way of working, and if they can solve their problems with their services/products. </p>
                    <p data-aos="zoom-in" data-aos-offset="200" data-aos-delay="50" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-mirror="true" data-aos-once="false">At Make My Website, we position you as a brand and create your own space where you can engage with your target audience.</p>
                </div>
            </div>
            <ServiceDelivery/>
