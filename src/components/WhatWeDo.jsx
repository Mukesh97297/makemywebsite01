...
function WhatWeDo() {
    return (
        ...
        //             <div className='What-we-do-vedio'>
        //                 <video autoPlay muted loop src="https://www.makemywebsite.com.au/wp-content/uploads/2022/01/MVI_4003_Trim1.mp4" type="video/mp4"></video>
        //             </div>
        //             <div style={{ top: '0', position: 'absolute' }}>
        //                 <div className='discreption'>
        //                     <div className='container'>
        //                         <div className='discreption-description'>
