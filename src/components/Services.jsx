        ...
        <div>
            <div className="container-fluid pl-5 pt-5" id="about-container">
                <div className="row pt-5">
                    <div className="col-md-12 py-5 pl-5 paragraph">
            ...
            <div className='container-fluid'>
                <div className='conainer'>
                    <div className='row justify-content-center Services-heading py-5'>
            ...
            <div className='container-fluid digital-marketing'>
                <div className='container'>
                    <div className='row py-5'>
                        ...
                        <div className='col-lg-6 marketing pt-5 justify-content-center'>
            ...
            <div className='container-fluid email-hosting'>
                <div className='container'>
                    <div className='row py-5'>
                        ...
                        <div className='col-lg-6 emails-host'>
            ...
            <div className='container-fluid photography-vediography'>
                <div className='container'>
                    <div className='row py-5'>
                        ...
                        <div className='col-lg-6 photography'>
